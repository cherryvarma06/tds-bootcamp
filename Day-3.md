...
--- Before Day-3 ---
I already knew how to write basic Python scripts and had used pip install before to add packages, but I had no idea about uv or how to manage project dependencies properly without polluting the global environment. ...
--- 
...
--- After Day-3 ---
I learned these things as well, apart from the checklist -Day 3 was very insightful, especially learning about uv as a modern alternative to pip and venv. The comparison between global pip install and isolated environments made it clear why good habits matter early on. It would be helpful to see a real-world project example using uv from start to finish. ...
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback-Day 3 was very insightful, especially learning about uv as a modern alternative to pip and venv. The comparison between global pip install and isolated environments made it clear why good habits matter early on. It would be helpful to see a real-world project example using uv from start to finish. ... ...
---
